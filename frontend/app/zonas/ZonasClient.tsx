        ...
        <div className="grid gap-6 lg:grid-cols-3">
          <section className="rounded-lg border border-gray-200 bg-white p-6">
            ...
            <p className="mb-4 rounded-lg bg-emerald-50 px-3 py-2 text-sm text-emerald-900">
              Pedidos confirmados de lunes a sábado hasta las <strong>{CUTOFF} hs</strong> se
              entregan el mismo día; después de esa hora, la entrega pasa al próximo día hábil
      ...
      <div className="mt-12 rounded-lg border border-gray-200 bg-gray-50 p-6">
        ...
        <ul className="space-y-2 text-gray-700">
          ...
          <li>
            ...
            <Link href="/es/terminos" className="text-emerald-700 hover:underline">
              ver términos
            </Link>
            ).
          </li>

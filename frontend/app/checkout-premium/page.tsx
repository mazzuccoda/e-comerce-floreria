...
const CheckoutPremiumPage = () => {
    ...
    items: [
      {
        producto: {
          ...
          precio: 89000,
          imagen_principal: 'https://via.placeholder.com/400x300?text=Rosas+Rojas'
        },
        quantity: 1,
        total_price: 89000
      },
      {
        producto: {
          ...
          precio: 65000,
          imagen_principal: 'https://via.placeholder.com/400x300?text=Arreglo+Mixto'
        },
        quantity: 1,
        total_price: 65000
      }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-green-50/30" style={{
      backgroundImage: `
      ...
      <div className="container mx-auto px-6 py-16 max-w-7xl">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-gray-600 font-light max-w-2xl mx-auto leading-relaxed">
            Estás a un paso de recibir las flores más frescas y hermosas
          </p>
        </div>
